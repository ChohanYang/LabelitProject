...
//import kotlinx.android.synthetic.main.activity_phone_main.*
//
//class PhoneMainActivity : AppCompatActivity(), View.OnClickListener {
//
...
//        startActivity(
//            Intent(this,PhoneLoginActivity::class.java).putExtra("phoneNumber",phoneNumber))
//        // close the current ;)
//        finish()
//    }
//
